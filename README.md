...
- **Admin Panel (Teacher Panel)** :man_teacher:
  ...
  - **View Results**: Access and view results of exams conducted by the logged-in users
...
- **Student Panel** :boy::girl:
  ...
  - **Profile Management**: Update profile details conveniently from the Settings section.
  - **View Announcements**: Read announcements FROM userss in the Messages section.
...
*Screenshot of the exam being attempted by the users.*
...
4. Read announcements FROM userss in the Messages section.
