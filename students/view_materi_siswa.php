...
<h1 class="h3 mb-2 text-gray-800"><?php echo $nama_materi;?></h1>
        <a href="detail_materi.php?id_kelas=<?php echo $id_kelas;?>&id_mapel=<?php echo $id_mapel;?>" class="btn btn-secondary btn-icon-split">
...
<?php
    ...
    if(empty($baris['hasil_nilai'])) {
        echo "HARAP KERJAKAN <a style='color:red'>PENILAIAN SEBELUM PEMBELAJARAN</a> TERLEBIH DAHULU UNTUK MENGAKSES MATERI";
    }
    else {
