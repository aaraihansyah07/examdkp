        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav style="margin-top:-2.5%; background:#3d4857; height:35px" class="navbar navbar-expand navbar-light topbar mb-2 static-top shadow">
                    ...
                    <a href="detail_penilaian_pra_pembelajaran.php?id_mapel=<?php echo $id_mapel?>&id_kelas=<?php echo $id_kelas;?>" style="color:white; margin-left:0.5%; font-size:90%">Penilaian Pra Pembelajaran ></a>
                    <a href="#" style="color:white; margin-left:1.3%; font-size:90%">Penilaian</a>
                </nav>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <a href="detail_penilaian_pra_pembelajaran.php?id_mapel=<?php echo $id_mapel?>&id_kelas=<?php echo $id_kelas;?>" class="btn btn-secondary btn-icon-split">
                                ...
                                <div class="card-body">
                                    <?php
                                        while ($baris = mysqli_fetch_array($hasil)) {
                                            ...
                                            if(empty($barisc['jawaban_siswa'])) {
                                                echo "<div style='display:inline-block; margin:1% 1% 3% 1%; width:20%'>";
                                                    echo "<a href='pengerjaan_diagnostik_siswa.php?exid=".$exid."&no_soal=".$no_soals."&id_mapel=".$id_mapel."&id_kelas=".$id_kelas."' style='background:red; border:none' class='btn btn-success btn-circle btn-md'>";
                                                        echo $no;
                                                    echo "</a><br>";
                                                echo "</div>";
                                            }
                                                ...
                                                echo "<div style='display:inline-block; margin:1% 1% 3% 1%; width:20%'>";
                                                    echo "<a href='pengerjaan_diagnostik_siswa.php?exid=".$exid."&no_soal=".$no_soals."&id_mapel=".$id_mapel."&id_kelas=".$id_kelas."' style='border:none' class='btn btn-success btn-circle btn-md'>";
                                                        echo $no;
                                                    echo "</a><br>";
                                                echo "</div>";
                                            } 
                     ...
                     <div class="col-xl-9 col-lg-10">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                        <form method='post' action="pengerjaan_diagnostik_siswa.php?exid=<?php echo $exid;?>&no_soal=<?php echo $no_soal;?>&id_mapel=<?php echo $id_mapel;?>&id_kelas=<?php echo $id_kelas;?>" style='font-size:18px'>
                                        <input required type='radio' name='jawaban_siswa' value='A' <?php echo ($jawaban_dipilih == 'A') ?  "checked" : "" ;  ?>/> A. <?php echo $barisb['OPTION_A']; ?><br>
                                            ...
                                            ?>
                                            <a href="pengerjaan_diagnostik_siswa.php?exid=<?php echo $exid; ?>&no_soal=<?php echo $no_soal_sebelumnya;?>&id_mapel=<?php echo $id_mapel;?>&id_kelas=<?php echo $id_kelas;?>" class="btn btn-secondary btn-icon-split">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-arrow-left"></i>
                                                </span>
                                            ...
                                            ?>
                                            <a style="float:right" href="pengerjaan_diagnostik_siswa.php?exid=<?php echo $exid; ?>&no_soal=<?php echo $no_soal_selanjutnya;?>&id_mapel=<?php echo $id_mapel;?>&id_kelas=<?php echo $id_kelas;?>" class="btn btn-secondary btn-icon-split">
