            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="../ganti_password.php" data-toggle="modal" data-target="#changeModal">
                ...
                <div class="container-fluid">
                    <?php
                        ...
                        $sql = "SELECT COUNT(id_guru) jml_guru from exm_list where kelas = $id_kelas AND status_assign = 'Y'";
                        $hasil = mysqli_query($koneksi, $sql);
                        $baris = mysqli_fetch_array($hasil);

                        $sql2 = "SELECT COUNT(id_guru) jml_guru from materi_tugas where id_kelas = $id_kelas";
                        $hasil2 = mysqli_query($koneksi, $sql2);
                        $baris2 = mysqli_fetch_array($hasil2);
                        
                        $sql4 = "SELECT COUNT(id_guru) jml_guru from soal_formatif_pbl where id_kelas = $id_kelas";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Asesmen Diagnostik</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $baris['jml_guru'];?> Asesmen</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Materi</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $baris2['jml_guru'];?> Materi</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Asesmen Formatif</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $baris4['jml_guru'];?> Asesmen</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
    ...
    <div class="modal fade" id="changeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Password Baru</div>
                <form method="post" action="../ganti_password.php" class="user" style="padding:2%">
                    <input type="hidden" name="id_user" value="<?php echo $_SESSION['user_id'];?>">
                    <input name="new_pw" type="password" class="form-control form-control-user" id="exampleInputPassword">
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <button class="btn btn-primary" name="ganti_password" href="../ganti_password.php">Save</button>                </div>
            </div>
            </form>
        </div>
    </div>
