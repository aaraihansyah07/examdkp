...
<head>
    ...
    <title>SISPEMDIF - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="prediksi-stok.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Prediksi Stock</span>
                </a>
                <a class="nav-link collapsed" href="riwayat_prediksi_stok.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Riwayat Prediksi Stock</span>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="data_master_obat.php">Obat</a>
                        <a class="collapse-item" href="#">Cabang Klinik</a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-border.html">Role User</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>SISPEMDIF makes extensive use of Bootstrap 4 utility classes in order to reduce
