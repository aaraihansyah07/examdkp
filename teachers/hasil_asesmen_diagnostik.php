...
<!-- Topbar -->
                ...
                <nav style="margin-top:-2.5%; background:#3d4857; height:35px" class="navbar navbar-expand navbar-light topbar mb-2 static-top shadow">
                    <a href="#" style="color:white; margin-left:1.3%; font-size:90%">Hasil Asesmen Diagnostik</a>
                </nav>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        $sql = "SELECT nama_kelas from master_kelas";
                        $hasil = mysqli_query($koneksi, $sql);
                        $baris = mysqli_fetch_array($hasil);
                        
                        
                    ?>
                    <h1 class="h3 mb-2 text-gray-800 ml-1">Hasil Asesmen Diagnostik</h1>
                    <!-- DataTales Example -->
                   <div class="row">
                   ...
                   <div class="col-xl-12 col-lg-13">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">                                        
                                    <?php
                                        // $sql2 = "SELECT a.kode_assign, e.exname, e.kelas, (SELECT nama_kelas from master_kelas where master_kelas.id = e.kelas) nama_kelas from assign_ruang_kelas a left join exm_list e on e.kode_assign = a.kode_assign
                                        // where e.id_guru = $id_guru AND e.status_assign = 'Y';";
                                        $sql2 = "SELECT kode_assign, exname, kelas, (SELECT nama_kelas from master_kelas where master_kelas.id = exm_list.kelas) nama_kelas
                                        from exm_list where id_guru = $id_guru AND status_assign = 'Y'";
                                        $hasil2 = mysqli_query($koneksi, $sql2);

                                        while ($baris2 = mysqli_fetch_array($hasil2)) {
                                    ?>
                                        <a class="nav-link collapsed" style="padding:none" href="exid_hasil_asesmen_diagnostik.php?id_kelas=<?php echo $baris2['kelas'];?>" id="nav_content">
                                            <span style='font-weight:bold; color:green; text-transform:uppercase'><?php echo $baris2['nama_kelas']; ?></span><br>
                                        </a>
                                        <hr class="sidebar-divider" style="margin-top:1%">
                                    <?php
                                        }
                                    ?>
                                </div>
