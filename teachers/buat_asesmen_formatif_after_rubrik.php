...
<!-- Topbar -->
                ...
                <nav style="margin-top:-2.5%; background:#3d4857; height:35px" class="navbar navbar-expand navbar-light topbar mb-2 static-top shadow">
                    <a href="asesmen_formatif.php" style="color:white; margin-left:1.3%; font-size:90%">Asesmen Formatif</a>                </nav>

                <div class="container-fluid">

<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800"></h1>
        <a href="buat_asesmen_formatif_pilih_rubrik.php" class="btn btn-secondary btn-icon-split">
...
?>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                        ...
                        $sql1 = "SELECT MAX(id) maxid from soal_formatif_pbl";
                        ...
                        if (empty($baris1['maxid'])) {
                            ...
                            $kode_materi = "for". $baris1['maxid']+1;
                        }
                    ?>
                </tbody>
            </table>
        </div>
    <form class="user" action="#" method="post" style="padding:2% 2% 0 2%">
    <p><b>Nama Asesmen Formatif</b></p>
    ...
    <div style="background:#d1d7e3; padding:2%; border-radius:3px; margin-top:0.5%">
        <p><b>Asesmen Formatif Rubrik kategori '<?php echo $baris2a['kategori']?> (<?php echo $baris2a['rentang_from'];?> - <?php echo $baris2a['rentang_to'];?>)'</b></p>
        <input type="hidden" name="<?php echo $seq_rubrik_asesmen;?>" value="<?php echo $baris2a['id'];?>"/>
        <input style="border:none; background:#d1d7e3" class="form-control" type="file" name="uploadfile"/><br>
        <div class="form-group">
    ...
    <div class="modal-footer">
            <a href="buat_asesmen_formatif_pilih_rubrik.php" class="btn btn-primary" style="border:none; background:red">Cancel</a>
    ...
    <?php
        if (isset($_POST['buat_materi'])) {
            ...
            $sql2c = "INSERT INTO soal_formatif_pbl(jenis, nama_materi, kode_materi, id_mata_pelajaran, id_guru, id_kelas, kode_assign)
            VALUES('S', '$nama_materi', '$kode_materi', $id_mata_pelajaran, $id_guru, $id_kelas, '$kode_assign')";
            $hasil2c = mysqli_query($koneksi, $sql2c);

            $sql2d = "SELECT id from soal_formatif_pbl where kode_materi = '$kode_materi'";
            ...
            for($i=1; $i<=$nos; $i++) {
                ...
                $sql2c = "INSERT INTO detail_soal_formatif_pbl(jenis, id_materi, kode_materi, isi_materi, kode_assign, seq_rubrik_asesmen)
                VALUES('S', $id_new, '$kode_materi', '$materies', '$kode_assign', $sequence)";
                $hasil2c = mysqli_query($koneksi, $sql2c);
                
                echo "$sequence, $materies<br>";
            }
            header('location:asesmen_formatif.php');
        }
    ?>
