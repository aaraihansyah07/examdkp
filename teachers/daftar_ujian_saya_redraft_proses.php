<?php
    ...
    if ($date_now < $tanggal_ujian) {
        ...
        echo "<script>alert('Soal ujian berhasil dijadikan draft kembali!'); window.location.href='daftar_ujian_saya_edit.php?hdrujn=$id_ujian_hdr&mp=".$mp."&kls=".$kls."&ju=".$ju."';</script>";
    }
    else {
         echo "<script>alert('Tidak dapat dijadikan draft kembali karena sudah melebihi atau sama dengan tanggal ujian'); window.location.href='daftar_ujian_saya_edit.php?hdrujn=$id_ujian_hdr&mp=".$mp."&kls=".$kls."&ju=".$ju."';</script>";
    }
