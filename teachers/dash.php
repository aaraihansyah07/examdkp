...
if (!isset($_SESSION["user_id"])){
	header("Location: ../login_usersphp");
}
include '../config.php';
...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <span class="logo_name">SISPEMDIF</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="#" class="active">
        ...
        <li>
          <a href="asesmen_diagnostik.php">
            <i class='bx bx-book-content' ></i>
            <span class="links_name">Asesmen Diagnostik</span>
          </a>
        </li>
        <li>
          <a href="asesmen_diagnostik.php">
            <i class='bx bx-book-content' ></i>
            <span class="links_name">Materi</span>
          </a>
        </li>
        <li>
          <a href="asesmen_diagnostik.php">
            <i class='bx bx-book-content' ></i>
            <span class="links_name">Asesmen Formatif</span>
          </a>
        </li>
        <li>
          <a href="exams.php">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Dashboard Guru</span>
      </div>
      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            ...
            <div class="number"><?php  $sql="SELECT COUNT(1) FROM users"; $result = mysqli_query($conn, $sql); $row=mysqli_fetch_array($result); echo $row['0'] ?></div>
            <div class="brief">
          ...
          <table id="res">
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <td id="res"><?php $uname=$row['uname']; $sql_name="SELECT * FROM users WHERE uname='$uname'"; $result_name=mysqli_query($conn, $sql_name); $row_name=mysqli_fetch_assoc($result_name); echo $row_name['fname']; ?></td>
