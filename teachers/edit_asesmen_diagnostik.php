...
<!-- Topbar -->
                ...
                <nav style="margin-top:-2.5%; background:#3d4857; height:35px" class="navbar navbar-expand navbar-light topbar mb-2 static-top shadow">
                    ...
                    <a href="#" style="color:white; margin-left:0.5%; font-size:90%">Edit Asesmen Diagnostik</a>
                </nav>

                <div class="container-fluid">

<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Edit Asesmen Diagnostik</h1>
...
?>
<form class="user" action="proses_edit_asesmen_diagnostik.php" method="post" style="padding:2% 2% 0 2%">
                                        <?php
                                            include('config.php');
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="mapel" value="<?php echo $subject_guru;?>">
                                        ...
                                        <div class="form-group">
                                            <?php
                                                ...
                                                while ($barisb = mysqli_fetch_array($hasilb)) {
                                                    echo "<input required type='radio' name='kelas' value='".$barisb['id']."'>". $barisb['nama_kelas']. "<br>";
                                                }
                                            ?>                                            
                                        </div>
                                        <p><b>Nama Asesmen</b></p>
                                        <div class="form-group">
                                            <input required value="<?php echo $baris['exname']; ?>" name="exname" type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Nama Asesmen">
                                        </div>
                                        <!-- <p><b>Waktu Asesmen</b></p>
                                        <div class="form-group">
                                            <input value="<?php echo $baris['extime']; ?>" name="extime" type="datetime-local" class="form-control form-control-user"
                                                id="exampleInputPassword">
                                        </div>
                                        <p><b>Waktu Penyerahan</b></p>
                                        <div class="form-group">
                                            <input value="<?php echo $baris['subt']; ?>" name="subt" type="datetime-local" class="form-control form-control-user"
                                                id="exampleInputPassword">
                                        </div> -->
                                        <p><b>Keterangan</b></p>
                                        <div class="form-group">
                                            <input value="<?php echo $baris['desp']; ?>" name="desp" type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Keterangan">
                                        </div>
                                    <div class="modal-footer">
                                        <a href="asesmen_diagnostik.php" class="btn btn-primary" style="border:none; background:red">Cancel</a>
                                        <button class="btn btn-primary" name="edit_akun">Save</button>
                                    </div>
</form>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="../admin/hapus_akun_guru.php?id=<?php echo $teacherid; ?>">Hapus</a>
                </div>
            </div>
        </div>
    </div>
