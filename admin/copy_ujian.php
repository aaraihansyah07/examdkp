<?php
    ...
    if (!isset($_POST['id_subkelas'])) {
        echo "<script>alert('Pilih subkelas yang dituju untuk dicopy!'); window.location.href='list_ujian_edit.php?hdrujn=$id_ujian_hdr&mp=".$mp."&kls=".$kls."&ju=".$ju."';</script>";
    }
        ...
        foreach ($id_subkelas as $subkelas) {
            ...
            if ($baris6c['cek_ada'] > 0) {
                echo "<script>alert('Ada ujian yang sudah pernah dibuat sebelumnya pada kelas yang dituju, silakan cek kembali daftar ujian yang sudah dibuat'); window.location.href='list_ujian_edit.php?hdrujn=$id_ujian_hdr&mp=".$mp."&kls=".$kls."&ju=".$ju."';</script>";
                exit;
            }
            // Simpan header ujian
        ...
        echo "<script>alert('Soal berhasil dicopy sebagai draft!'); window.location.href='list_ujian_edit.php?hdrujn=$id_ujian_hdr&mp=".$mp."&kls=".$kls."&ju=".$ju."';</script>";
    }
