...
<head>
    ...
    <style>
        #icon_buat_ujian_dari_excel {color:white}
        #buat_ujian_dari_excel {color:white; font-weight:bold}
    </style>
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="w-full mx-auto p-4 bg-white shadow rounded-lg mt-6" x-data="soalForm()">
                            <form action="buat_ujian_by_admin_dari_excel_proses.php" method="POST" enctype="multipart/form-data">
