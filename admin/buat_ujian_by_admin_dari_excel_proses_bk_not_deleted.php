...
try {
    foreach ($id_subkelas as $subkelas) {
        ...
        foreach ($sheet->getRowIterator(2) as $row) {
            ...
            // ✅ Konversi Unicode Math ke LaTeX
            ...
            $stmtDtl = $db->prepare("
                ...
                (nilai, no_soal, id_ujian_hdr, isi_soal, isi_soal_unicode, gambar_soal_filename, option_a, option_a_unicode, option_b, option_b_unicode, option_c, option_c_unicode, option_d, option_d_unicode, option_e, option_e_unicode, kunci_jawaban)
                VALUES
                (:nilai, :no_soal, :id_ujian_hdr, :pertanyaan, :pertanyaan_unicode, :gambar_soal, :opsi_a, :opsi_a_unicode, :opsi_b, :opsi_b_unicode, :opsi_c, :opsi_c_unicode, :opsi_d, :opsi_d_unicode, :opsi_e, :opsi_e_unicode, :jawaban)
            ");
            $stmtDtl->execute([
                ':nilai' => $nilai,
                ':no_soal' => $data[0] ?? '',
