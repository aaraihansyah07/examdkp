...
if (isset($_POST["adduser"])) {
    ...
    $check_user = mysqli_num_rows(mysqli_query($conn, "SELECT uname FROM users WHERE uname='$uname'"));
    ...
    if ($pword !== $cpword) {
      ...
      $sql = "INSERT INTO users (uname, pword, fname, dob, gender, email) VALUES ('$uname', '$pword', '$fname', '$dob', '$gender', '$email' )";
