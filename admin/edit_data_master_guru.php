        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav style="margin-top:-2.5%; background:#3d4857; height:35px" class="navbar navbar-expand navbar-light topbar mb-2 static-top shadow">
                    <a href="data_master_guru.php" style="color:white; margin-left:1.3%; font-size:90%">Data Master Guru ></a>
                    <a href="#" style="color:white; margin-left:0.5%; font-size:90%">Edit Guru</a>
                </nav>
...
<h1 class="h3 mb-2 text-gray-800">Edit Guru</h1>
        <a href="data_master_guru.php" class="btn btn-secondary btn-icon-split">
...
<?php
    ...
    if (isset($_POST['btn_edit'])) {
        ...
        $sql = "SELECT nip, nama_guru, uuidguru, tanggal_lahir, mapel.nama_mata_pelajaran, g.kode_mata_pelajaran,
...
?>
<form class="user" action="proses_edit_data_master_guru.php" method="post" style="padding:2% 2% 0 2%">
    <div style="display: flex; flex-wrap: wrap; gap: 20px;">
        ...
        <div style="flex: 1; min-width: 300px;">
            ...
            <input value="<?php echo $baris['nip'];?>" name="nip" type="text" class="form-control">
            </div>

            <!-- <p><b>Tanggal Lahir</b></p>
            <div class="form-group">
            <input value="<?php echo $baris['tanggal_lahir'];?>" name="tanggal_lahir" type="date" class="form-control">
            </div> -->
        </div>
        ...
        <div style="flex: 1; min-width: 300px;">
            <p><b>Nama</b></p>
            <div class="form-group">
            <input required value="<?php echo $baris['nama_guru'];?>" name="nama_guru" type="text" class="form-control">
            </div>
        </div>
        <div style="flex: 1; min-width: 300px;">    
            <p><b>Gender</b></p>    
            <select name="gender" style="width: 100%; padding: 8px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
    ...
    <div class="modal-footer">
        <a href="data_master_guru.php" class="btn btn-primary" style="border:none; background:red">Cancel</a>
