                            ...
                            <form enctype="multipart/form-data" action="buatsoal_asesmen_diagnostik.php?exid=<?php echo $exid?>" method="post">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group" style="border:none">
                                            <input style="border:none" class="form-control" type="file" name="uploadfile" value="" />
                                        </div>
                                        ...
                                        <select style="border-radius:10px" name="kunci_jawaban">
                                            ...
                                            <option selected><?php echo $baris3['KUNCI_JAWABAN']; ?></option>
                                        ...
                                        <?php  
                                                ...
                                                if (isset($_POST[$nomor_soal])) {
                                                    ...
                                                    echo "TESTING : $isi_soals, $option_as, $option_bs, $option_cs, $option_ds, $option_es, $kunci_jawabans";
